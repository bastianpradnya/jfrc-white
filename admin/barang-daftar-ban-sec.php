...
?>
    ...
    <div class="col-lg-12">
        <h1 class="page-header">Ban Second</h1>
    </div>
        <!-- /.row -->
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                $sql = "SELECT id, nama_barang, harga, stok, status, kategori_barang,
                                    waktu_publish, photo_1 FROM barang WHERE kategori_barang ='Ban Second' ORDER BY id DESC LIMIT $posisi, $batas ";
                                    ...
                                    <td colspan="9">
                                        ...
                                        <ul class="pagination">
                                            ...
                                            for($i=1;$i<=$jmlhalaman;$i++)
                                                if ($i != $halaman){
                                                    echo "<li><a href='barang-daftar-ban-sec.php?halaman=$i'>$i</a></li> ";
                                                }
                                                else{
