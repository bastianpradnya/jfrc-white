...
?>
    ...
    <div class="col-lg-12">
        <h1 class="page-header">Knalpot R9</h1>
    </div>
        <!-- /.row -->
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                $sql = "SELECT id, nama_barang, harga, stok, status, kategori_barang,
                                    waktu_publish, photo_1 FROM barang WHERE kategori_barang ='Knalpot Creampie' ORDER BY id DESC LIMIT $posisi, $batas ";
                                ...
                                <tr>
                                    <td colspan="9">
                                        <?php
                                        $query2     = mysqli_query($conn, "select id, nama_barang, harga, stok, status, kategori_barang, waktu_publish, photo_1 FROM barang");
                                        ...
                                        <ul class="pagination">
                                            ...
                                            for($i=1;$i<=$jmlhalaman;$i++)
                                                if ($i != $halaman){
                                                    echo "<li><a href='barang-daftar-r9.php?halaman=$i'>$i</a></li> ";
                                                }
                                                else{
